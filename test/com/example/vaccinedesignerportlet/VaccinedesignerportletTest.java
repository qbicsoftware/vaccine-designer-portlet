package com.example.vaccinedesignerportlet;
 ...
 */
public class VaccinedesignerportletTest extends TestBenchTestCase {
    @Rule
    ...
    private void openTestUrl() {
        getDriver().get("http://localhost:8080/vaccineDesignerPortlet");
    }
