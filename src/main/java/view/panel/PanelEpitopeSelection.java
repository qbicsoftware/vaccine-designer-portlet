...
public class PanelEpitopeSelection extends CustomComponent {
  ...
  public void setDataGrid(BeanItemContainer<EpitopeSelectionBean> container, String methodColumn,
      String[] alleleNames, boolean type, boolean transcriptExpression, boolean unc, boolean dist) {
    ...
    // adjust grid
    dataGrid
        .setColumnOrder("included", "excluded", "neopeptide", "type", "length", "mutation", "gene",
            "transcript", "transcriptExpression", "hlaA1", "uncA1", "distA1", "hlaA2", "uncA2",
            "distA2", "hlaB1", "uncB1", "distB1", "hlaB2", "uncB2", "distB2", "hlaC1", "uncC1",
            "distC1", "hlaC2", "uncC2", "distC2");
    ...
    dataGrid.getDefaultHeaderRow().getCell("included")
        .setHtml("<font color='#2c972'>" + FontAwesome.CHECK_CIRCLE.getHtml() + "</font>");
    dataGrid.getDefaultHeaderRow().getCell("excluded")
        .setHtml("<font color='#ed473b'>" + FontAwesome.TIMES_CIRCLE.getHtml() + "</font>");
