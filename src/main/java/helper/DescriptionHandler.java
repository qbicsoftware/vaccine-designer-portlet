...
public class DescriptionHandler {
  ...
  // PanelUpload
  private String uploadData_selectUpload =
      "Welcome to the <b>Interactive Vaccine Designer</b>. The functionality is based on  <a href=\"https://github.com/APERIM-EU/WP3-EpitopeSelector\"target=\"_blank\">EpitopeSelector</a>, a software package for RNA-Seq based neo-epitope selection. \n"
          +
          "\n" +
  ...
  private String results =
      "Here are the <b>results</b> of your current session. You have now the following options: \n"
          +
